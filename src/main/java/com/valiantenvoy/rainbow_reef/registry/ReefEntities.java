...
public class ReefEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Jellyfish>> JELLYFISH = registerEntity("jellyfish", Jellyfish::new, MobCategory.WATER_CREATURE, builder -> builder.sized(1.25F, 1.1F).eyeHeight(0.9F).clientTrackingRange(10));
