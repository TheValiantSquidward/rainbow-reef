...
public class ReefEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MahiMahi>> MAHI_MAHI = registerEntity("mahi_mahi", MahiMahi::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.5F, 0.5F).eyeHeight(0.25F).clientTrackingRange(10));
