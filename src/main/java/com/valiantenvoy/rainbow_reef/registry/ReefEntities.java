...
public class ReefEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Crab>> CRAB = registerEntity("crab", Crab::new, MobCategory.CREATURE, builder -> builder.sized(0.6F, 0.35F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Frogfish>> FROGFISH = registerEntity("frogfish", Frogfish::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.5F, 0.5F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Jellyfish>> JELLYFISH = registerEntity("jellyfish", Jellyfish::new, MobCategory.WATER_CREATURE, builder -> builder.sized(1.2F, 1.2F).eyeHeight(0.9F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<LargeShark>> LARGE_SHARK = registerEntity("large_shark", LargeShark::new, MobCategory.WATER_CREATURE, builder -> builder.sized(1.3F, 1.3F).eyeHeight(0.65F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Lionfish>> LIONFISH = registerEntity("lionfish", Lionfish::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.7F, 0.7F).eyeHeight(0.35F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MaoriWrasse>> MAORI_WRASSE = registerEntity("maori_wrasse", MaoriWrasse::new, MobCategory.WATER_CREATURE, builder -> builder.sized(1.15F, 1.15F).eyeHeight(0.575F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<MoorishIdol>> MOORISH_IDOL = registerEntity("moorish_idol", MoorishIdol::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.5F, 0.7F).eyeHeight(0.35F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Parrotfish>> PARROTFISH = registerEntity("parrotfish", Parrotfish::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.6F, 0.6F).eyeHeight(0.3F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Pipefish>> PIPEFISH = registerEntity("pipefish", Pipefish::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.5F, 0.3F).eyeHeight(0.15F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Ray>> RAY = registerEntity("ray", Ray::new, MobCategory.WATER_CREATURE, builder -> builder.sized(0.9F, 0.35F).eyeHeight(0.175F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Seahorse>> SEAHORSE = registerEntity("seahorse", Seahorse::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.5F, 0.75F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SmallShark>> SMALL_SHARK = registerEntity("small_shark", SmallShark::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.6F, 0.4F).eyeHeight(0.2F).clientTrackingRange(10));
