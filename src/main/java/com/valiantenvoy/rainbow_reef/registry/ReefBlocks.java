...
public class ReefBlocks {
    ...
    public static final DeferredBlock<Block> PINK_SEA_ANEMONE = registerBlock("pink_sea_anemone", () -> new SeaAnemoneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).strength(0.5F).sound(SoundType.CORAL_BLOCK).noOcclusion()));
    public static final DeferredBlock<Block> BROWN_SEA_ANEMONE = registerBlock("brown_sea_anemone", () -> new SeaAnemoneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).strength(0.5F).sound(SoundType.CORAL_BLOCK).noOcclusion()));
    public static final DeferredBlock<Block> PURPLE_SEA_ANEMONE = registerBlock("purple_sea_anemone", () -> new SeaAnemoneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(0.5F).sound(SoundType.CORAL_BLOCK).noOcclusion()));
    ...
    public static final DeferredBlock<Block> PUFFER_LANTERN = registerBlock("puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> WHITE_PUFFER_LANTERN = registerBlock("white_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> LIGHT_GRAY_PUFFER_LANTERN = registerBlock("light_gray_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> GRAY_PUFFER_LANTERN = registerBlock("gray_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> BLACK_PUFFER_LANTERN = registerBlock("black_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> BROWN_PUFFER_LANTERN = registerBlock("brown_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> RED_PUFFER_LANTERN = registerBlock("red_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> YELLOW_PUFFER_LANTERN = registerBlock("yellow_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel(state -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> LIME_PUFFER_LANTERN = registerBlock("lime_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel(state -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> CYAN_PUFFER_LANTERN = registerBlock("cyan_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel(state -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> LIGHT_BLUE_PUFFER_LANTERN = registerBlock("light_blue_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel(state -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> PURPLE_PUFFER_LANTERN = registerBlock("purple_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> MAGENTA_PUFFER_LANTERN = registerBlock("magenta_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> PINK_PUFFER_LANTERN = registerBlock("pink_puffer_lantern", () -> new PufferLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).strength(0.5F, 0.0F).sound(SoundType.LANTERN).lightLevel((state) -> 15).noOcclusion().pushReaction(PushReaction.DESTROY)));
