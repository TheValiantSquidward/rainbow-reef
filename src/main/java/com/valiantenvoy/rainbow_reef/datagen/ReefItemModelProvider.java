...
public class ReefItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        this.item(DAMSELFISH_BUCKET);
        this.item(RAW_DAMSELFISH);

        this.item(DWARF_ANGELFISH_BUCKET);
        this.item(RAW_DWARF_ANGELFISH);
        this.item(DWARF_ANGELFISH_TART);

        this.item(FUSILIER_BUCKET);
        this.item(RAW_FUSILIER);
        ...
        this.item(LARGE_SHARK_BUCKET);

        this.item(LIONFISH_BUCKET);
        this.item(RAW_LIONFISH);
