...
public class Butterflyfish extends VariantSchoolingFish {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new FishDigGoal(this, 15, 600, ReefTags.BUTTERFLY_DIET));
    ...
    public ResourceLocation fallbackVariantTexture() {
        return RainbowReef.location("textures/entity/butterflyfish/butterflyfish_copperband.png");
    }
}