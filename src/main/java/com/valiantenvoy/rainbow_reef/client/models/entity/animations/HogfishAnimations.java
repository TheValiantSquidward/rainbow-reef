 ...
 */
@OnlyIn(Dist.CLIENT)
public class HogfishAnimations {
	...
	public static final AnimationDefinition PECK = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(28.3216F, -13.2721F, -7.0531F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.625F, KeyframeAnimations.degreeVec(27.1632F, 8.9953F, 4.3764F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(22.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.875F, KeyframeAnimations.degreeVec(22.3568F, 13.918F, 5.6498F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 2.0F, 2.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5417F, KeyframeAnimations.posVec(0.0F, -0.25F, -0.25F), AnimationChannel.Interpolations.LINEAR),
			...
			new Keyframe(1.0417F, KeyframeAnimations.posVec(0.0F, -1.25F, -0.25F), AnimationChannel.Interpolations.LINEAR),
			...
			new Keyframe(1.5417F, KeyframeAnimations.posVec(0.0F, -2.25F, -0.25F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.125F, KeyframeAnimations.degreeVec(0.0F, 1.25F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();
}