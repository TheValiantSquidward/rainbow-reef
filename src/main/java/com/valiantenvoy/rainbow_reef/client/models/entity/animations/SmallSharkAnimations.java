...
public class SmallSharkAnimations {
	...
	public static final AnimationDefinition SWIM = AnimationDefinition.Builder.withLength(2.0F).looping()
			...
			.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 0.48F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					...
					new Keyframe(1.3333F, KeyframeAnimations.posVec(0.0F, 1.3F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 1.52F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.6667F, KeyframeAnimations.posVec(0.0F, 1.6F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.8333F, KeyframeAnimations.posVec(0.0F, 1.52F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
