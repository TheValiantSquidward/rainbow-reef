...
public class FrogfishAnimations {
	...
	public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
			...
			.addAnimation("fin_top", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.5F, KeyframeAnimations.degreeVec(-0.67F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("fin_bottom", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.5F, KeyframeAnimations.degreeVec(-0.67F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.5833F, KeyframeAnimations.degreeVec(-0.67F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.75F, KeyframeAnimations.degreeVec(-9.33F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
