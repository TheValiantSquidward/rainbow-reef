...
public class SharkModel extends ReefModel<Shark> {
	...
	public SharkModel(ModelPart root) {
		...
		this.fin_dorsal = this.body.getChild("fin_dorsal");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition jaw_upper = head.addOrReplaceChild("jaw_upper", CubeListBuilder.create().texOffs(0, 26).addBox(-4.0F, -4.0F, -10.0F, 8.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, 0.0F));
		...
		PartDefinition fin_dorsal = body.addOrReplaceChild("fin_dorsal", CubeListBuilder.create().texOffs(0, 47).addBox(-0.5F, -6.0F, 0.0F, 1.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, -6.0F, 1.0F));

		PartDefinition fin_left = body.addOrReplaceChild("fin_left", CubeListBuilder.create().texOffs(53, 8).addBox(5.0F, 0.0F, 5.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition fin_right = body.addOrReplaceChild("fin_right", CubeListBuilder.create().texOffs(53, 8).mirror().addBox(-7.0F, 0.0F, 5.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition tail2 = tail1.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(26, 40).addBox(-0.5F, -7.0F, 0.0F, 1.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition fin_pelvic_left = tail1.addOrReplaceChild("fin_pelvic_left", CubeListBuilder.create().texOffs(36, 50).addBox(0.0F, 0.0F, -1.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition fin_pelvic_right = tail1.addOrReplaceChild("fin_pelvic_right", CubeListBuilder.create().texOffs(36, 50).mirror().addBox(-5.0F, 0.0F, -1.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
