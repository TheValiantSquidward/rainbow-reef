...
public class Butterfish extends VariantSchoolingFish {
    ...
    public static boolean canSpawn(EntityType<Butterfish> entityType, LevelAccessor level, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
        return WaterAnimal.checkSurfaceWaterAnimalSpawnRules(entityType, level, reason, p_223364_3_, p_223364_4_);
    }
    @Nullable
