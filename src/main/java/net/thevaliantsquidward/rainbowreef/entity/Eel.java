...
public class Eel extends RRMob implements Bucketable {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(Eel.class, EntityDataSerializers.INT);
    ...
    public Eel(EntityType<? extends WaterAnimal> entityType, Level level) {
 ...
 //   }
    ...
    public static <T extends Mob> boolean canSpawn(EntityType<Eel> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
