...
import net.thevaliantsquidward.rainbowreef.entity.goalz.RandomSleepyLookaroundGoal;
import net.thevaliantsquidward.rainbowreef.entity.goalz.RandomSleepySwimGoal;
