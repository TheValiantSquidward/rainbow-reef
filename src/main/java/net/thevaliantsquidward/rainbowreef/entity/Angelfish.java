...
public class Angelfish extends VariantSchoolingFish implements Bucketable, VariantEntity {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(Angelfish.class, EntityDataSerializers.INT);
