...
public class LionfishEntity extends RRMob implements Bucketable {

    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(LionfishEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(LionfishEntity.class, EntityDataSerializers.INT);
    ...
    public LionfishEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
    ...
    public static <T extends Mob> boolean canSpawn(EntityType<LionfishEntity> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
