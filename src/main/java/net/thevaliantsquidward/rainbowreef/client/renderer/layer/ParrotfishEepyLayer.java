...
public class ParrotfishEepyLayer extends RenderLayer<ParrotfishEntity, ParrotfishModel<ParrotfishEntity>> {

    public ParrotfishEepyLayer(RenderLayerParent<ParrotfishEntity, ParrotfishModel<ParrotfishEntity>> renderer) {
        super(renderer);
    }

    public ResourceLocation eepyTextures(ParrotfishEntity entity) {
        return new ResourceLocation(RainbowReef.MOD_ID, "textures/entity/parroteepy/parrotfish_sleepy_" + entity.getVariant() + ".png");
    }

    public void render(PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, ParrotfishEntity entity, float pLimbSwing, float pLimbSwingAmount, float pPartialTicks, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
