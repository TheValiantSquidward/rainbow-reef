...
public class EelRenderer extends MobRenderer<EelEntity, EelModel<EelEntity>> {
    ...
    @Override
    protected void setupRotations(EelEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
