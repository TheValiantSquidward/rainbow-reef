...
import net.thevaliantsquidward.rainbowreef.client.animations.BillfishAnimations;
...
public class BillfishModel extends ReefModel<Billfish> {
	...
	public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 38).addBox(-2.5F, -6.0F, -9.0F, 5.0F, 10.0F, 18.0F, new CubeDeformation(0.0F))
                .texOffs(46, 58).addBox(-0.5F, -1.0F, -25.0F, 1.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 0.0F, -1.0F));
        ...
        PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(66, 0).addBox(-0.5F, -6.0F, 5.0F, 0.0F, 12.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(46, 38).addBox(-2.0F, -3.0F, 0.0F, 3.0F, 6.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 1.0F, 9.0F));
